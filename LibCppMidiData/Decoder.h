// Decoder.h - Declares the Decoder class.
//
...
namespace MidiData
{
    ...
    /// data from a file stream. A class that derives from MidiData::Decoder can
    /// also maintain and decode sub-decoders (child MidiData::Decoder instances). 
    ...
    protected:
        ...
        virtual std::shared_ptr<Decoder> NextSubDecoder() = 0;
