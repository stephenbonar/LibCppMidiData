// PitchWheelChangeMessage.cpp - Defines the PitchWheelChangeMessage class.
//
...
void PitchWheelChangeMessage::FinishDecoding(BinData::FileStream* s)
{
    type = EventType::PitchWheelChangeMessage;
